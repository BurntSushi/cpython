...
class StripExtraTests(unittest.TestCase):
    ...
    def test_no_data(self):
        ...
        self.assertEqual(b + b"z", zipfile._Extra.strip(b + b"z", (self.ZIP64_EXTRA,)))
    ...
    def test_multiples(self):
        ...
        self.assertEqual(b"z", zipfile._Extra.strip(a + a + b"z", (self.ZIP64_EXTRA,)))
        self.assertEqual(
    ...
    def test_too_short(self):
        ...
        self.assertEqual(b"zz", zipfile._Extra.strip(b"zz", (self.ZIP64_EXTRA,)))
        self.assertEqual(b"zzz", zipfile._Extra.strip(b"zzz", (self.ZIP64_EXTRA,)))
