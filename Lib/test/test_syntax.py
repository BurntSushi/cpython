...
"""
    ...
    def test_error_string_literal(self):
        ...
        self._check_error(
            r'"blech\"',
            r"unterminated string literal \(.*\); perhaps you escaped the end quote",
        )
        self._check_error(
            r'r"blech\"',
            r"unterminated string literal \(.*\); perhaps you escaped the end quote",
...
"""
    ...
    def test_syntax_error_non_matching_elif_else_statements(self):
        ...
        self._check_error("else:\n    ...", "'else' must match a valid statement here")
        self._check_noerror("if a == b:\n    ...\nelif a == c:\n    ...")
        self._check_noerror("if x == y:\n    ...\nelse:\n    ...")
        self._check_error("else = 123", "invalid syntax")
        self._check_error("elif 55 = 123", "cannot assign to literal here")
