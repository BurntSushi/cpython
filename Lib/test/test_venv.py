...
class BasicTest(BaseTest):
    ...
    def _check_output_of_default_create(self):
        ...
        cmd = (
            f"command = {sys.executable} -m venv{copies} --without-pip "
    ...
    def test_scm_ignore_files_git(self):
        ...
        """
        self.run_with_capture(venv.create, self.env_dir, scm_ignore_files={"git"})
    ...
    def test_create_scm_ignore_files_empty(self):
        ...
        self.assertIn(
            "--without-scm-ignore-files", self.get_text_file_contents("pyvenv.cfg")
        )
