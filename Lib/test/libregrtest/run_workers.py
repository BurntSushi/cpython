...
class WorkerThread(threading.Thread):
    ...
    def _run_process(
        self, runtests: RunTests, output_fd: int, tmp_dir: StrPath | None = None
    ) -> int | None:
    ...
    def create_worker_runtests(
        ...
        return self.runtests.copy(tests=tests, json_file=json_file, **kwargs)

    def run_tmp_files(
        self, worker_runtests: RunTests, stdout_fd: int
