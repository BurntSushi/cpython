...
class TestCPyTime(CPyTimeTestCase, unittest.TestCase):
    ...
    def test_FromSeconds(self):
        ...
        self.check_int_rounding(
            lambda secs, rnd: _PyTime_FromSeconds(secs),
    ...
    def test_FromSecondsObject(self):
        ...
        self.check_int_rounding(
            _PyTime_FromSecondsObject, lambda secs: secs * SEC_TO_NS
        )

        self.check_float_rounding(
            _PyTime_FromSecondsObject, lambda ns: self.decimal_round(ns * SEC_TO_NS)
        )
    ...
    def test_AsSecondsDouble(self):
        ...
        self.check_int_rounding(
            lambda ns, rnd: _PyTime_AsSecondsDouble(ns), float_converter, NS_TO_SEC
        )
    ...
    def test_AsTimeval(self):
        ...
        self.check_int_rounding(
            _PyTime_AsTimeval, timeval_converter, NS_TO_SEC, value_filter=seconds_filter
        )

    @unittest.skipUnless(
        hasattr(_testinternalcapi, "_PyTime_AsTimespec"),
    ...
    def test_AsTimespec(self):
        ...
        self.check_int_rounding(
            lambda ns, rnd: _PyTime_AsTimespec(ns),
            timespec_converter,
            NS_TO_SEC,
    ...
    @unittest.skipUnless(
        hasattr(_testinternalcapi, "_PyTime_AsTimeval_clamp"),
    ...
    @unittest.skipUnless(
        hasattr(_testinternalcapi, "_PyTime_AsTimespec_clamp"),
    ...
    def test_AsMilliseconds(self):
        ...
        self.check_int_rounding(
            _PyTime_AsMilliseconds, self.create_decimal_converter(MS_TO_NS), NS_TO_SEC
        )
    ...
    def test_AsMicroseconds(self):
        ...
        self.check_int_rounding(
            _PyTime_AsMicroseconds, self.create_decimal_converter(US_TO_NS), NS_TO_SEC
        )
...
class TestOldPyTime(CPyTimeTestCase, unittest.TestCase):
    ...
    def test_object_to_time_t(self):
        ...
        self.check_int_rounding(
            _PyTime_ObjectToTime_t, lambda secs: secs, value_filter=self.time_t_filter
        )

        self.check_float_rounding(
            _PyTime_ObjectToTime_t, self.decimal_round, value_filter=self.time_t_filter
        )
