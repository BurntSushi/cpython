...
class ConfigDictTest(BaseTest):
    ...
    def test_baseconfig(self):
        ...
        self.assertEqual(
            bc.convert("cfg://adict[nest4][alpha numeric 1 with spaces]"), 5
        )
        self.assertEqual(
            bc.convert("cfg://adict[nest4][aplha numeric 1 %( - © ©ß¯]"), 9
        )
        ...
        self.assertEqual(bc.convert("cfg://adict[nest4].somedict[a]"), 1)
        self.assertEqual(
            bc.convert("cfg://adict[nest4].somedict[a with 1 and space]"), 3
        )
        self.assertEqual(
            bc.convert("cfg://adict[nest4].somedict[a with ( and space]"), 4
        )
        self.assertEqual(bc.convert("cfg://adict.nest4.somelist[1][1]"), "i")
        self.assertEqual(bc.convert("cfg://adict.nest4.somelist[2]"), "j")
        self.assertEqual(bc.convert("cfg://adict.nest4.somedict.a"), 1)
        ...
        self.assertRaises(
            KeyError, bc.convert, "cfg://adict[alpha numeric ] 1 with spaces]"
        )
        self.assertRaises(
            ValueError, bc.convert, "cfg://adict[ aplha ]] numeric 1 %( - © ©ß¯] ]"
        )
        self.assertRaises(
            ValueError, bc.convert, "cfg://adict[ aplha [ numeric 1 %( - © ©ß¯] ]"
        )
...
class LoggerAdapterTest(unittest.TestCase):
    ...
    def test_extra_merged(self):
        self.adapter = logging.LoggerAdapter(
            logger=self.logger, extra={"foo": "1"}, merge_extra=True
        )
