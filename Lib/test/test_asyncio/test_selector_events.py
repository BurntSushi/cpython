...
class BaseSelectorEventLoopTests(test_utils.TestCase):
    ...
    def test_add_reader_existing(self):
        ...
        writer = mock.Mock()
        self.loop._selector.get_map.return_value = {
            1: selectors.SelectorKey(1, 1, selectors.EVENT_WRITE, (reader, writer))
        }
        cb = lambda: True
        self.loop.add_reader(1, cb)
    ...
    def test_add_reader_existing_writer(self):
        writer = mock.Mock()
        self.loop._selector.get_map.return_value = {
            1: selectors.SelectorKey(1, 1, selectors.EVENT_WRITE, (None, writer))
        }
        cb = lambda: True
        self.loop.add_reader(1, cb)
    ...
    def test_remove_reader(self):
        self.loop._selector.get_map.return_value = {
            1: selectors.SelectorKey(1, 1, selectors.EVENT_READ, (None, None))
        }
    ...
    def test_add_writer_existing(self):
        ...
        writer = mock.Mock()
        self.loop._selector.get_map.return_value = {
            1: selectors.SelectorKey(1, 1, selectors.EVENT_READ, (reader, writer))
        }
        cb = lambda: True
        self.loop.add_writer(1, cb)
    ...
    def test_remove_writer(self):
        self.loop._selector.get_map.return_value = {
            1: selectors.SelectorKey(1, 1, selectors.EVENT_WRITE, (None, None))
        }
