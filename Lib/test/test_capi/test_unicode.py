...
class CAPITest(unittest.TestCase):
    ...
    def test_equaltoutf8(self):
        ...
        self.assertEqual(
            equaltoutf8("\udcfe", "\udcfe".encode("utf8", "surrogateescape")), 0
        )
        self.assertEqual(
            equaltoutf8("\udcfe", "\udcfe".encode("utf8", "surrogatepass")), 0
        )
        self.assertEqual(
            equaltoutf8("\ud801", "\ud801".encode("utf8", "surrogatepass")), 0
        )
    ...
    def test_equaltoutf8andsize(self):
        ...
        # Surrogate characters are always treated as not equal
        self.assertEqual(
            equaltoutf8andsize("\udcfe", "\udcfe".encode("utf8", "surrogateescape")), 0
        )
        self.assertEqual(
            equaltoutf8andsize("\udcfe", "\udcfe".encode("utf8", "surrogatepass")), 0
        )
        self.assertEqual(
            equaltoutf8andsize("\ud801", "\ud801".encode("utf8", "surrogatepass")), 0
        )
